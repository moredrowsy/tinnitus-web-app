  ...
  return (
    <div className='w-full'>
      {soundMetadasArray.map((sData) => {
        ...
        return (
          <div className='flex' key={sData.id}>
            <div className='flex-1 justify-center items-center m-10 bg-white'>
              <div className='rounded overflow-hidden shadow-lg'>
                <div className='px-6 py-4'>
                  <div className='font-bold text-xl mb-2'>{sData.title}</div>
                  <div className='flex justify-start items-center'>
                    <div className='flex-1 flex flex-col justify-start items-start'>
                      ...
                      />
                      <div className='h-7 w-7 font-bold text-xl text-black rounded-full flex items-center justify-center font-mono'>
                        {sData.votes || 0}
                      </div>
                      <ChevronDownIcon
